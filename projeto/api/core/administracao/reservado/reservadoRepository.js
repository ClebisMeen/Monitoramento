...
function inserirReservado(params, callback) {
    pg.query("SELECT * FROM ADMINISTRACAO.INSERIRLARESERVADO($1, $2);",
        [
...
function listarReservado(params, callback) {
    pg.query("SELECT * FROM ADMINISTRACAO.LISTARLARESERVADO($1);",
        [
...
function editarReservado(params, callback) {
    pg.query("SELECT * FROM ADMINISTRACAO.EDITARLARESERVADO($1,$2,$3,$4);",
        [
            params.idLaboratorio,
            params.idProfessor,
            params.horaInicio,
...
function excluirReservado(params, callback) {
    pg.query("SELECT * FROM ADMINISTRACAO.EXCLUIRLARESERVADO($1);",
        [
            params.idLaboratorio
        ],
        (err, rows) => {
